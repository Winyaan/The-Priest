...
public class Game extends JPanel implements ActionListener, MouseListener {
    ...
    public Game() {
        ...
        level[0] = loader.loadImage("/TDS/res/Level1.png");
        level[1] = loader.loadImage("/TDS/res/Level2.png");
        level[2] = loader.loadImage("/TDS/res/Level3.png");
        sprite_sheet = loader.loadImage("/TDS/res/Projectp.png");
